...
For one, it has no natural stopping point. If creating happy lives is good, why stop at farm animals? The same logic could justify breeding humans for benevolent purposes, which we rightly find abhorrent. This suggests something's wrong with the underlying principle.
...
The Logic of the Larder asks us to accept a lot of maybes to justify definite slaughter. Maybe farm animals have net-positive lives. Maybe those lives outweigh early death. Maybe we can scale humane farming. That's a lot of uncertainty to stake against certain killing.
...
From this narrow perspective, farm animals might seem privileged. Regular meals, veterinary care, protection from predators, shelter from elements. Some philosophers have even argued we should intervene in nature to reduce wild animal suffering—though such proposals raise profound questions about our relationship with the natural world.footnote:[Pearce, D. (2015). "A Welfare State for Elephants? A Case Study of Compassionate Stewardship." Relations: Beyond Anthropocentrism, 3(2), 133-152.]
