# CLAUDE.md - "You Probably Shouldn't Eat Animals" Project Context

## Project Overview
The author is writing a short book titled "You Probably Shouldn't Eat Animals" based on their 2018 blog post "Against Thanksgiving." The book uses a unique structural device where emphasizing different words in the title creates different interpretations, with each word becoming a chapter.

## Core Philosophy
- **Epistemic humility**: Using "probably" sincerely, not rhetorically
- **Precautionary principle**: When there's reasonable suspicion of harm and alternatives exist, we should abstain
...
### Chapter Order
Originally conceived as: You → Probably → Shouldn't → Eat → Animals
**Reversed to**: Animals → Eat → Shouldn't → Probably → You

**Reasoning**: Start with philosophical foundations (animal consciousness) before moving to practical application (individual change). Natural progression from "animals suffer" → "eating causes harm" → "creates moral obligation" → "despite uncertainty" → "yes, you personally."

### Target Audience
Not narrowly defined, but especially speaking to the "thoughtful dodger" who:
- Knows the arguments but hasn't internalized them
- Takes comfort in systemic solutions as moral deferral
- Would describe themselves as "reducing meat intake"
- Appreciates intellectual honesty over evangelical fervor

### Tone and Approach
- "Calling it like I see it" - personal but not preachy
...
- Avoids common vegan rhetoric pitfalls
