...
This kind of epistemic hedging might seem like weakness, but I've come to see it as a strength. The kind that admits when it doesn't know something. The kind that says "probably" and means it.

Which brings us to this chapter, and to that load-bearing word in our title. "Probably" isn't there for false modesty or rhetorical flourish. It's there because honest engagement with the ethics of eating animals reveals genuine uncertainties. What if consciousness is rarer than we think? What if farmed animals truly are better off existing than not? What if nature really is crueler than agriculture? What if some people need animal products to thrive?

These aren't bad faith objections or gotcha questions. They're real challenges that deserve real consideration. And taking them seriously strengthens the case for plant-based eating, turning dogma into a reasoned response to moral uncertainty.
...
But let's say I'm wrong. Let's say there's only a 10% chance that pig is suffering. Is that a gamble worth taking for bacon?

Think of it this way: If I handed you a button that had a 90% chance of doing nothing but a 10% chance of torturing someone for hours, would you press it for a sandwich? That's what we do when we buy factory-farmed meat, betting against consciousness with someone else paying the price if we're wrong.
...
Push this logic far enough and you reach the reductio ad absurdum: What if plants are conscious? What if bacteria suffer? What if rocks have feelings? At some point, moral consideration becomes so expansive it collapses into paralysis.
...
Another challenging argument goes like this: That bacon on your plate is the reason the pig existed at all. No demand for bacon, no pig. And if that pig lived a good life, socializing with other pigs, rooting in mud, enjoying whatever pigs enjoy, then eating bacon created happiness that wouldn't otherwise exist. By this logic, the pig should thank you for your appetite.
...
And there's something to this. A world with happy pigs frolicking in pastures might contain more total welfare than a world without those pigs. If we could guarantee truly good lives for farm animals, the Logic of the Larder would have real force.
...
But let's imagine happy farm animals. The argument still faces serious challenges.
...
I find this argument hard to shake. Happy lives might indeed be valuable, even if they end in slaughter. I can't prove that a world without farm animals is better than one with happy farm animals. Things get murky here.

But that's exactly why the "probably" in our title matters. When we're uncertain about deep questions of welfare and value, when we're gambling with sentient lives, which way should we err?
...
But this comparison misses some real distinctions.

==== Different Problems, Different Solutions

The first mistake is treating wild and farmed animal suffering as an either/or proposition. These are different ethical challenges requiring different approaches.
...
But what if you really can't live without animal products? For some people, the answer is necessity, whether biological, geographical, or cultural. These exceptions challenge vegan universalism in ways that matter.
...
This isn't a lifestyle choice. It's thermodynamics. At -40°F, humans doing outdoor work need 5,000+ calories a day, as the cold combined with physical activity creates enormous energy demands. Seal blubber provides those calories in a way no imported plant food could match, even if shipping Impossible Burgers to the Arctic Circle weren't absurdly impractical.

Similar realities face pastoral communities worldwide. The Maasai of East Africa, Mongolian herders, Himalayan yak farmers. For people in environments where crops won't grow, animals convert inedible grasses into human nutrition. These are entire cultures evolved to thrive where plant agriculture fails.footnote:[Fratkin, E. (1997). "Pastoralism: Governance and development issues." Annual Review of Anthropology, 26(1), 235-261.]

Then there's the sovereignty issue. When Indigenous peoples practice traditional hunting, they're maintaining relationships with land, ancestors, and identity that have been under threat for centuries. Telling them to go vegan can look like the latest chapter in cultural imperialism.footnote:[Kim, C. J. (2015). Dangerous Crossings: Race, Species, and Nature in a Multicultural Age. Cambridge University Press.]

==== Subsistence Versus Scale

These exceptions are real and deserve respect. But they prove the rule rather than invalidate it.

Traditional subsistence hunting and industrial animal agriculture are different categories entirely. One involves small-scale, place-based practices often maintained for millennia. The other involves raising and killing 80 billion land animals annually in a system that's existed for mere decades.footnote:[FAO. (2021). FAOSTAT statistical database. Rome: Food and Agriculture Organization of the United Nations.]

These traditional systems also can't scale. There's not enough huntable wildlife to feed 8 billion people through hunting. Not enough marginal grassland for universal pastoralism. These practices work precisely because they're limited to specific peoples in specific places. Try to globalize them and they collapse, along with the ecosystems they depend on.
...
What matters is recognizing contexts. Unnecessary harm remains problematic whether inflicted by industrial agriculture or traditional practices. But subsistence hunting by marginalized peoples isn't the priority problem, and pretending otherwise is both strategically foolish and morally confused.

For the tiny percentage of humans who truly need animal products, whether due to geography, biology, or circumstance, the ethical framework shifts. The question becomes not "whether" but "how": how to minimize harm, respect relationships, and acknowledge necessity.
...
The existence of genuine edge cases makes the center case clearer. Unless you're reading this in an igloo, on the Mongolian steppes, or in a gastroenterologist's office, the exceptions probably don't apply to you.
...
High-welfare farming offers a different fix. Maybe we keep eating animals but treat them well first. Pasture-raised, cage-free, one bad day. If we must kill, at least minimize suffering. Some small farms achieve this vision.
...
The barrier, then, isn't taste or convenience. It's motivation. People need reasons beyond "it's just as good" to change lifelong habits. They need to believe it matters.
...
The waiting game assumes we need perfection before taking imperfect action. But practical ethics doesn't demand perfection. It asks only that we do the best we can with what we have.
...
But the uncertainty does something useful: it clarifies the ethics rather than paralyzing them.
...
This is how we handle uncertainty everywhere. We buy insurance despite being uncertain about accidents. We wear seatbelts despite being uncertain about crashes. We avoid dark alleys despite being uncertain about danger. When potential harm is serious and alternatives exist, uncertainty guides us toward caution.
...
We should choose them without self-righteousness or false certainty, but probably, and with good reason.
