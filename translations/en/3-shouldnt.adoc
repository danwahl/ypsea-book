...
The sugar boycotters faced familiar criticisms. Individual choices wouldn't end slavery. The economy depended on sugar production. Boycotting was mere virtue signaling that ignored larger systemic issues. And yet, within decades, Britain abolished slavery throughout its empire. The boycott hadn't single-handedly ended the institution, but it had done something that mattered: it transformed a distant atrocity into a daily moral choice, making the political personal and the personal political.
...
The Scottish philosopher noticed that moral arguments tend to pull a fast one. They start with statements about how the world is (descriptive facts anyone can observe) then suddenly jump to claims about how the world ought to be (prescriptive commands about right and wrong). This leap, Hume argued, is logically suspicious. You can't derive an "ought" from an "is" any more than you can derive "wet" from "H~2~O" without already knowing what water does.footnote:[Hume, D. (1739). A Treatise of Human Nature. The specific passage about is-ought appears in Book III, Part I, Section I.]
...
See the jump? Even if we accept the factual premise, the conclusion doesn't follow automatically. We've smuggled in an unstated assumption: that causing suffering is something we ought to avoid. Hume's point is that we need to be honest about our philosophical foundations, not that morality is bunk.
...
Life, by its very nature, is goal-directed. Every organism from beetles to blue whales acts to preserve itself and promote its wellbeing. That's a biological fact, not a philosophical stance. When we recognize this, a basic ought emerges: life ought to act to preserve and promote itself.footnote:[This argument draws from the tradition of ethical naturalism. For a detailed treatment, see Foot, P. (2001). Natural Goodness. Oxford University Press.]
...
This isn't a cop-out. Every system of reasoning needs starting points. Just as we accept that 2+2=4 without being able to prove it from more basic principles (since any proof would rely on mathematical reasoning that assumes basic arithmeticfootnote:[Or maybe "Just as we accept the Peano axioms..."]), we might accept "unnecessary suffering is wrong" as a foundational moral truth: an axiom we take as self-evident rather than derived.
...
The third bridge rests on plain observation: we effortlessly derive oughts from is-statements all the time.
...
Consider how three major ethical traditions (deontology, utilitarianism, and virtue ethics) approach intensive animal agriculture.

==== The Rights Approach: It's About Justice

Deontological ethics, the philosophy of rights and duties, judges actions by their inherent nature rather than consequences. From this perspective, the core question is whether eating animals violates fundamental duties of justice, not merely whether it causes harm (though it does).
...
The utilitarian verdict is clear: whatever pleasure we get from eating a bacon cheeseburger cannot justify the suffering required to produce it. That's basic arithmetic, and it comes with a body count.footnote:[The common objection, that individual choices don't affect the calculation, misunderstands both markets and morality. Markets aggregate individual choices; that's literally how they work. Every purchase is a vote for more production. But even if your individual impact were negligible, utilitarian ethics includes a key principle: you don't get to ignore small probabilities when the stakes are high. If there's even a small chance your choices reduce suffering, the expected value calculation still points toward plant-based eating.]
...
Yet symbolism has power. When hundreds of universities divested billions of dollars, it sent a message that reverberated from corporate boardrooms to Pretoria. The economic impact mattered less than the moral statement: we refuse to participate.
...
But they also knew something else: visible non-participation changes what feels normal. It forces comfortable people to confront uncomfortable questions. It transforms "that's just how things are" into "that's a choice we're making."
...
Ask someone if they think animals should suffer unnecessarily and they'll say no. Then watch them order a burger. (And watch yourself stop getting invited to dinner parties if you point out the contradiction.)
...
When someone refuses to eat animals, they're not just making a personal choice. They're creating what psychologists call a "moral threat" to everyone around them.footnote:[Minson, J. A., & Monin, B. (2012). "Do-gooder derogation: Disparaging morally motivated minorities to defuse anticipated reproach." Social Psychological and Personality Science, 3(2), 200-207.]
...
This isn't conflict avoidance; it's how moral change happens. Social movements rarely succeed by argument alone; they succeed by making alternative choices visible, viable, and eventually normal. Every plant-based meal in public normalizes the choice. Every polite "no thanks" to the passed appetizers raises questions. Every substitution at a restaurant makes the next person's substitution easier.

The goal isn't to be a walking judgment on others' choices but to be a living example that different choices are possible. When someone asks why you don't eat animals, and they will ask, you have an opportunity for connection, not confrontation. Most people already share your values; they just haven't connected them to their plates yet.
...
This is where we need to be careful, because movements have a tendency to self-destruct through purity testing. The goal isn't to achieve some state of perfect moral cleanliness. (Spoiler: you can't. Even vegetable agriculture involves some harm to animals.) The goal is to reduce participation in unnecessary suffering while building a more ethical and just food system.

This means meeting people where they are. The person who does Meatless Mondays is moving in the right direction. The flexitarian who usually chooses plant-based is an ally, not an apostate. The vegetarian who still eats cheese is on a journey, not a hypocrite.

Perfect adherence to ethical ideals is impossible in a complex world. But impossible perfection doesn't excuse us from possible improvement. The question is whether you can reduce harm, not eliminate it; whether you can stop actively supporting the worst unjust systems, not opt out of all of them.
...
The sugar boycotters didn't know their small refusal would help catalyze the end of British slavery. They just knew they couldn't continue participating once they understood what their participation meant. The question facing us is whether we'll continue participating once we know what our participation means, not whether our individual choices will single-handedly transform industrial agriculture.
